...
app.post('/api/generate', async (req, res) => {
  ...
  console.log('...stage 1...');
  // const transformedCss = await queryGemini(css);
  // return;
  ...
  exec(command, { cwd: tempDir }, (error) => {
    ...
    // console.log('partial css', transformedCss.slice(0, 10));
    ...
    //   console.log('...stage 5: Installing Angular Material...');
      
    //   // Switch to exec for better compatibility
    //   const addMaterialCommand = process.platform === 'win32' 
    //     ? `npx.cmd -p @angular/cli@${angular_v} ng add @angular/material --skip-confirmation --skip-install`
    //     : `npx -p @angular/cli@${angular_v} ng add @angular/material --skip-confirmation --skip-install`;
      
    //   exec(addMaterialCommand, { cwd: projectPath }, (materialError, stdout, stderr) => {
    //     // Log outputs to see what's happening
    //     console.log('Material installation stdout:', stdout);
        
    //     if (stderr) {
    //       console.error('Material installation stderr:', stderr);
    //     }
    ...
    //     console.log('Angular Material installation completed');
    //     packageProject();
    //   });
    // } else {
